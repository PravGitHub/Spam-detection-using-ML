...
print("Spam Accuracy without stop words elimination:",(right_spam/(right_spam+wrong_spam) * 100))
print("Ham Accuracy without stop words elimination:",(right_ham/(right_ham+wrong_ham) * 100))
