...
print("spam accuracy with stopwords elimination:",(output_spam_dict['spam']/testspamlen)*100)
print("Ham accuracy with stopwords elimination:",(output_ham_dict['ham']/testhamlen)*100)
